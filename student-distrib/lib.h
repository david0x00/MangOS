...
void putc_page(uint8_t c, terminal_t* term);
void scroll_up();
void scroll_up_page(terminal_t* term);
uint32_t strlen_mod(const int8_t* s);

// read and set video memory location
int get_screen_x();
int get_screen_y();

void set_screen_x(int new_x);
void set_screen_y(int new_y);
void set_screen_x_page(int new_x, terminal_t* term);
void set_screen_y_page(int new_y, terminal_t* term);
